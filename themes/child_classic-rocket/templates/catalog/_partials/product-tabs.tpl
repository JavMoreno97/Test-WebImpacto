    <div class="tabs product-tabs card card-block border-0 p-0 mt-4">
        <ul class="nav nav-tabs justify-content-start" role="tablist">
            ...
            <li class="nav-item">
                <a
                        ...
                        {if !$product.description} aria-selected="true"{/if}>{l s='Product Reviews' d='Shop.Theme.Catalog'}</a>
            </li>
        ...
        <div class="tab-content px-4" id="tab-content">
          ...
          <div class="tab-pane fade{if !$product.description} show active{/if}" id="product-reviews" role="tabpanel">
