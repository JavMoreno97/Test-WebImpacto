...
<div class="images-container">
  ...
  {block name='product_images'}
      ...
      <div class="product-thumbs js-qv-product-images visible-desktop slick__arrow-outside" data-slick='{literal}{"asNavFor":"[data-slick].products-imagescover","slidesToShow": {/literal}{if $product.images|count > 2}{$product.images|count}{elseif $product.images|count > 5}5{/if}{literal}, "slidesToScroll": 1,"focusOnSelect": true,"centerMode":false,"rows": 0,"variableWidth": true}{/literal}' data-count="{$product.images|count}">
